...
//    Log4J classes also helps with reports
    ...
    ListOfUsersPage defaultPage;
    @BeforeMethod(alwaysRun = true)
    public void setUp(){
        loginPage=new LoginPageElements();
        defaultPage=new ListOfUsersPage();
...
//        We log the information using extentTest object.
    ...
    public void login() throws IOException {
        ...
        extentTest.pass("Login link ");
        loginPage.userName.sendKeys("manager");
        extentTest.pass("User entered username");
        loginPage.password.sendKeys(ConfigReader.getProperty("manager_password"));
        extentTest.pass("password");
        loginPage.loginButton.click();
       ReusableMethods.getScreenshot("DefaultPage");
        Assert.assertTrue(defaultPage.expression.isDisplayed());
        extentTest.pass("List of Users");
